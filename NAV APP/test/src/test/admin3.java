...
public class admin3 implements ActionListener {
	...
	admin3(){
		...
		lab5.setBackground(new Color(255,102,0));
		lab5.setOpaque(true);
		//lab4:
		lab4.setText("Manipulation Des Trajets");
		lab4.setForeground(new Color(255,102,0));
		lab4.setFont(new Font("Algerian", Font.BOLD, 40));
		lab4.setBounds(200,20,700,50);
		//lab:
		lab.setBounds(20, 150,400, 400);
		lab.setBackground(new Color(255,102,0));
		lab.setOpaque(true);
		...
		lab3.setText("-- Ajouter Un Trajet  --");
		...
		lab2.setText("--  Supprimer Un Trajet  --");
		...
		scrollPane.setBounds(460, 150, 507, 400);
		
		panel.add(scrollPane);
		
		scrollPane.setViewportView(table);
		scrollPane.setBorder(bordlab2);
		frame.setTitle("-- Manipulation Des Trajets --");
